...
router.delete('/departments/:id', authenticate, workspaceController.deleteDepartment);
router.post('/employees', authenticate, workspaceController.createEmployee);
router.delete('/employees/:id', authenticate, workspaceController.deleteEmployee);
